...
* 对叶子节点的交易进行增删，然后再对交易进行排序，对排序后的创建默克尔树就完成交易的增删
* 排序，在交易里添加交易生成时间，通过该时间来进行排序
*/
class MerkleTree{
    ...
    constructor(trxs){
        ...
        //交易hash数组
        this.leaves = this.createLeaves(trxs)
        //交易hash生成的树
        this.tree = this.createNodeTree(this.leaves)
